...
libraryDependencies ++= Seq(
  "org.reactivemongo" %% "reactivemongo-play-json" % "{{site._0_13_latest_minor}}"
)
{% endhighlight %}
...
[![Test coverage](https://img.shields.io/badge/coverage-69%25-green.svg)](https://reactivemongo.github.io/ReactiveMongo-Play-Json/coverage/{{site._0_13_latest_minor}}/)
...
**API documentations:** [ReactiveMongo Play JSON API](https://oss.sonatype.org/service/local/repositories/releases/archive/org/reactivemongo/reactivemongo-play-json_2.11/{{site._0_13_latest_minor}}/reactivemongo-play-json_2.11-{{site._0_13_latest_minor}}-javadoc.jar/!/index.html)
