...
libraryDependencies ++= Seq(
  "org.reactivemongo" %% "reactivemongo-play-json-compat" % "{% include play-version.md version=site._1_0_latest_minor play_suffix='play29' %}" // For Play 2.9.x (ajust accordingly)
)
```
