...
A detailed documentation is available about the [ReactiveMongo connections](releases/{{site.latest_major_release}}/documentation/tutorial/connect-database.html).
...
That's where the [streaming API](releases/{{site.latest_major_release}}/documentation/tutorial/consume-streams.html) comes to the rescue!
...
The developer documentation can be [browsed online](releases/{{site.latest_major_release}}/documentation/).

There is a pretty complete [Scaladoc](releases/{{site.latest_major_release}}/api/index.html) available. The code is accessible from the [Github repository](https://github.com/ReactiveMongo/ReactiveMongo). And obviously, don't hesitate to ask questions in the [ReactiveMongo Google Group](https://groups.google.com/forum/?fromgroups#!forum/reactivemongo)!
