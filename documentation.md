...
* [**Current stable version ({{site.latest_release}})**](/releases/{{site.latest_major_release}}/documentation/index.html)
  ...
  * [API](/releases/{{site.latest_major_release}}/api/index.html)
* Older releases
...
* The [documentation](/releases/{{site.latest_major_release}}/documentation/index.html) of the latest ReactiveMongo version ([__{{site.latest_release}}__](/releases/{{site.latest_major_release}}/documentation/index.html))
* Samples
